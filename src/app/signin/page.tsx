...
import { Mail, Lock, Loader2, BookOpen, AlertCircle, ArrowRight, Github } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-card border border-border rounded-3xl p-8 shadow-xl">
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <Link href="/signup" className="font-semibold text-foreground hover:text-accent transition-colors">
              Sign up
            </Link>
          </p>
        </div>
